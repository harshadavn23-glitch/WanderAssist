...
export default function SeniorBooking() {
  ...
  useEffect(() => {
    const raw = sessionStorage.getItem("seniorTripDetails");
    if (raw) {
      try {
  ...
  const { numPeople, numDays, tour, isFamily } = tripDetails;
  const subtotal = tour.price * numPeople;
  ...
  async function handlePay() {
    ...
    const ref = `SNR-${Math.floor(100000 + Math.random() * 900000)}`;
    setBookingId(ref);
    ...
    saveToBackend({
      ...
      .catch((err) => console.error("[SeniorBooking] backend save:", err));
    setProcessing(false);
    setConfirmed(true);
  }
        ...
        <div className="w-full max-w-lg space-y-6 text-center animate-slide-up">
          ...
          <div className="space-y-1">
            <h1 className="font-display font-bold text-3xl text-foreground">
              Senior Tour Confirmed!
            </h1>
            <p className="text-muted-foreground">
              Your senior tour has been successfully booked
            </p>
          </div>
          <div className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300 text-sm font-semibold">
            <Heart className="w-4 h-4" /> Senior care team will contact you 48
            hours before travel
          </div>
          <Card className="border-border shadow-elevated text-left">
            <CardContent className="p-6 space-y-3">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-sm">{tour.destination}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-sm text-muted-foreground">Travelers</span>
                <span className="font-medium">
                  {numPeople} {numPeople > 1 ? "seniors" : "senior"}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-sm text-muted-foreground">
      ...
      <div className="bg-card border-b border-border py-8 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-muted-foreground text-sm">
            {tour.name} · {tour.destination} · {numDays} Days
          </p>
        </div>
      </div>
            ...
            {step === 1 && (
              <div className="space-y-4 animate-fade-in">
                      ...
                      <div className="p-5 space-y-4">
                        ...
                        {isFamily && isChild && (
                          <div
                            ...
                            data-ocid={`snr-p${i}-cert-section`}
                          >
                            <div className="flex items-center gap-2 mb-1">
                            ...
                            <label
                              ...
                              data-ocid={`snr-p${i}-first-time-cert`}
                            >
                              <div
                ...
                <Button
                  ...
                  data-ocid="snr-add-passenger-btn"
                >
                ...
                <Card className="border-border">
                  <CardContent className="p-5 space-y-4">
                    ...
                    <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">
                      Emergency Contact (Required for Senior Tours)
                    </p>
                    <div className="grid grid-cols-2 gap-3">
                      <div className="space-y-1">
                    ...
                    <CardContent className="p-5 space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        ...
                        <button
                          ...
                          data-ocid="snr-upi-transfer-btn"
                        >
                          <div className="text-2xl mb-1">🏦</div>
                          <p className="text-sm font-semibold text-foreground">
                            Bank Transfer
            ...
            <Card className="border-border shadow-elevated">
              ...
              <CardContent className="space-y-3 text-sm">
                ...
                <p className="text-xs text-amber-600 dark:text-amber-400 flex items-center gap-1">
                  <Heart className="w-3 h-3" /> Senior care included
                </p>
              </CardContent>
            </Card>
          </div>
